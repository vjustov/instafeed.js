    ...
    switch @options.get
      ...
      when "tagged"
        ...
        if typeof @options.tagName isnt 'string'
          throw new Error "No tag name specified. Use the 'tagName' option and make sure the userID is a string type."
      ...
      when "location"
        ...
        if typeof @options.locationId isnt 'number'
          throw new Error "No location specified. Use the 'locationId' option and make sure the userID is an integer type."
      ...
      when "user"
        ...
        if typeof @options.accessToken isnt 'string'
          throw new Error "No access token. Use the 'accessToken' option and make sure the userID is an string type."
